...
public class GameRegions {
    ...
    private static final Map<String, List<SearchRegion>> REGIONS = Map.ofEntries(
            ...
            Map.entry("NewZealandAlps",
                    List.of(new SearchRegion("NewZealandAlps", 165.366211, -47.676238, 177.429199, -38.872305))),
            Map.entry("Himalaya",
                    List.of(new SearchRegion("HimalayaCentral", 66.401367, 26.155291, 103.754883, 44.495013))),
            Map.entry("JapaneseAlps",
                    List.of(new SearchRegion("JapaneseAlps", 136.582031, 34.385028, 142.998047, 41.214540))),
            Map.entry("Andes", List.of(new SearchRegion("Andes", -80.507813, -55.749307, -66.093750, 12.726004))));
