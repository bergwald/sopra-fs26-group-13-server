...
public class GameController {
	...
	public UserAnswerPutDTO makeGuess(@RequestBody UserGuessPutDTO userGuessObj,
		...
		return DTOMapper.INSTANCE.convertEntityToUserAnswerPutDTO(gameData, distance, scoreRound, scoreOverall, userGuessObj.getLatitude(), userGuessObj.getLongitude());
	}
}
